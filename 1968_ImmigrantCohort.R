...
adult_noncitizen_moms=subset(x,a_sex == 2 & a_age>=18 & prcitshp<4 &(pemntvty>=100|pemntvty>=100),select=c(h_seq,a_lineno))
adult_noncitizen_dads=subset(x,a_sex == 1 & a_age>=18 & prcitshp<4 & peinusyr >= 5, select = c(h_seq,a_lineno))
adult_noncitizen_moms=subset(x,a_sex == 2 & a_age>=18 & prcitshp<4 & prcitshp == 5, select = c(h_seq,a_lineno))
adult_noncitizen_dads=subset(x,a_sex == 1 & a_age>=18 & prcitshp<4 & prcitshp == 5, select = c(h_seq,a_lineno))

#MotherCOB=PEMNTVTY=pemntvty
#FatherCOB=PEFNTVTY=pefntvty

# Household subset 1
noncitizen_moms=subset(x, a_sex == 2 & a_age > 18 & prcitshp <= 4 & peinusyr >= 5, select = c(h_seq,a_lineno))
noncitizen_dads=subset(x, a_sex == 1 & a_age > 18 & prcitshp <= 4 & peinusyr >= 5, select = c(h_seq,a_lineno))
noncitizen_moms=subset(x, a_sex == 2 & a_age > 18 & peinusyr < 5 & prcitshp == 5, select = c(h_seq,a_lineno))
noncitizen_dads=subset(x, a_sex == 1 & a_age > 18 & peinusyr < 5 & prcitshp == 5, select = c(h_seq,a_lineno))
...
kids$kid_parent_noncitizen=as.numeric( kids$kid_parent_noncitizen_early %in% 1 |kids$kid_parent_noncitizen_70%in% 1 )
...
gen1_adult$adult_parent_noncitizen=as.numeric(gen1_adult$adult_parent_noncitizen_early%in%1|gen1_adult$adult_parent_noncitizen_70%in%1)
